...
###############################
define ASDF
# $(1): $$(addsuffix .c,$$(basename $$(subst $$(OBJPATH),$$(SRCPATH),$(1)))) | intro
# 	@echo -e $$(CYAN) $$(CC) $<$$(ENDCOLOR)
# 	@$$(CC) -c $$(CFLAGS) -I $$(_INCLUDES) $$(_SYSINCLUDES) -o $$@ $$<

# $(1): $$(addsuffix .cc,$$(basename $$(subst $$(OBJPATH),$$(SRCPATH),$(1)))) | intro
# 	@echo -e $$(CYAN) $$(CC) $<$(ENDCOLOR)
# 	@$$(CC) -c $(CFLAGS) -I $$(_INCLUDES) $$(_SYSINCLUDES) -o $$@ $$<

$(1): $$(addsuffix .cpp,$$(basename $$(subst $$(OBJPATH),$$(SRCPATH),$(1)))) | intro
	@echo -e $$(CYAN) $$(CXX) $$< $$(ENDCOLOR)
	@$$(CXX) -c $$(CPPFLAGS) $$(_INCLUDES) $$(_SYSINCLUDES) $$< -o $$@
endef

# for each object, call the above function to create a set of makefile rules
$(foreach obj,$(OBJECTS),$(eval $(call ASDF,$(obj))))