...
namespace gurps_track
{
    ...
    struct skill_listing_t
    {
        skill_t skill;
        size_t num_improvements = 0;

        skill_listing_t(skill_t _skill, int _initial_improvement_level);
    ...
    //     skill_listing_t get_skill(std::string name);
    // };
    using skill_list_t = std::vector<skill_listing_t>;
}
}
